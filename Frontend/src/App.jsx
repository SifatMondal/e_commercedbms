...
const ROUTES = [
  ...
  { pattern: "/messages", render: () => <ProtectedRoute allowedRoles={["customer", "seller", "deliveryman", "admin"]}><Messages /></ProtectedRoute> },
  { pattern: "/notifications", render: () => <ProtectedRoute allowedRoles={["customer", "seller", "deliveryman", "admin"]}><Notifications /></ProtectedRoute> },
